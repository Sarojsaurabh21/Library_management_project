...
public class BookManger {
	...
	public BookManger() throws ClassNotFoundException
	{
	...
	{
		// oos_book = new ObjectOutputStreaam(new FileOutputStream(book_file));
		 try {
	...
	/*public void updateBook(int update_isbn, String title, String author, String publisher, int edition,
			String subject) {
